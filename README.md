...
- In a terminal, navigate to `botbuilder-samples\samples\python\07.using-adaptive-cards` folder
- yes then is se zada to ab kuch kiya hi nahin ja sakta baby chalo aage hi chalte hain baby
